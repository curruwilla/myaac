...
if ($load_it) {
    ...
    if ($success) {
        ...
        if (hasFlag(FLAG_CONTENT_PAGES) || superAdmin()) {
            ...
            $content = $twig->render('admin.pages.links.html.twig', [
                    'page' => [
                        'id'     => $pageInfo !== null ? $pageInfo['id'] : 0,
                        'hidden' => $pageInfo !== null ? $pageInfo['hidden'] : '0',
                    ],
                ]) . $content;
        }
    } else {
