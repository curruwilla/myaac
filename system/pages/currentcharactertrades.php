...
if ($logged) { ?>
    <div class="CharacterTradeTibiaCoinBalance">
        <?= $getAccountCoins['coins'] ?>
        <img src="<?= $template_path; ?>/images//account/icon-tibiacoin.png" class="VSCCoinImages" title="Tibia Coins"> <?= $getAccountCoins['coins'] ?>
...
if (empty($getPageDetails) && empty($getPageAction)) {
    if (!$logged) {
        ...
        <div class="SmallBox">
            <div class="MessageContainer">
                <div class="BoxFrameHorizontal" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-horizontal.gif);"></div>
                <div class="BoxFrameEdgeLeftTop" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></div>
                <div class="BoxFrameEdgeRightTop" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></div>
                <div class="Message">
                    <div class="BoxFrameVerticalLeft" style="background-image:url(<?php
                    echo $template_path; ?>/images/global/content/box-frame-vertical.gif);"></div>
                    <div class="BoxFrameVerticalRight" style="background-image:url(<?php
                    echo $template_path; ?>/images/global/content/box-frame-vertical.gif);"></div>
                            ...
                            <td>
                                <div style="float: right;">
                                    <a href="?account/manage" target="_blank">
                                        <div class="BigButton" style="background-image:url(<?php
                                        echo $template_path; ?>/images/global/buttons/sbutton.gif)">
                                            <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                                                <div class="BigButtonOver" style="background-image: url(<?php
                                                echo $template_path; ?>/images/global/buttons/sbutton_over.gif); visibility: hidden;"></div>
                                                <input name="auction_confirm" class="BigButtonText" type="button" value="Login"></div>
                                        </div>
                                    </a>
                                </div>
                ...
                <div class="BoxFrameHorizontal" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-horizontal.gif);"></div>
                <div class="BoxFrameEdgeRightBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></div>
                <div class="BoxFrameEdgeLeftBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></div>
            </div>
        </div>
        <br>
    ...
    <div class="TableContainer">
        <div class="CaptionContainer">
            <div class="CaptionInnerContainer"><span class="CaptionEdgeLeftTop" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionEdgeRightTop" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionBorderTop" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/table-headline-border.gif);"></span> <span class="CaptionVerticalLeft" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-vertical.gif);"></span>
                <div class="Text">Current Auctions</div>
                <span class="CaptionVerticalRight" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-vertical.gif);"></span> <span class="CaptionBorderBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/table-headline-border.gif);"></span> <span class="CaptionEdgeLeftBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionEdgeRightBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></span></div>
        </div>
                                                        ...
                                                        <td>
                                                            <div class="Auction">
                                                                <div class="AuctionHeader">
                                                                    <div class="AuctionLinks"><a href="?subtopic=currentcharactertrades&details=<?php
                                                                        echo $Auction['id'] ?>"><img title="show auction details" src="<?php
                                                                            echo $template_path; ?>/images/global/content/button-details-idle.png"></a></div>
                                                                    <div class="AuctionCharacterName"><a href="?subtopic=currentcharactertrades&details=<?php
                                                                        echo $Auction['id'] ?>"><?php
                                                                            echo $getCharacter['name'] ?></a></div>
                                                                    Level: <?php
                                                                    echo $getCharacter['level'] ?> | Vocation: <?php
                                                                    echo $character_voc ?> | <?php
                                                                    echo $character_sex ?><br>
                                                                </div>
                                                                <div class="AuctionBody">
                                                                    
                                                                    <div class="AuctionBodyBlock AuctionDisplay AuctionOutfit"><?php
                                                                        echo $ribbon_status ?><img class="AuctionOutfitImage" src="<?php
                                                                        echo $outfit_url ?>"></div>
                                                                    <div class="AuctionBodyBlock AuctionDisplay AuctionItemsViewBox">
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[2]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[1]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[3]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[6]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[4]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[5]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[9]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[7]; ?></div>
                                                                        <div class="CVIcon CVIconObject"><?php
                                                                            echo $equipment[10]; ?></div>
                                                                    </div>
                                                                    <div class="AuctionBodyBlock ShortAuctionData">
                                                                        <div class="ShortAuctionDataLabel">Auction Start:</div>
                                                                        <div class="ShortAuctionDataValue"><?php
                                                                            echo date('d M Y, H:s:i', strtotime($Auction['date_start'])) ?></div>
                                                                        <div class="ShortAuctionDataLabel">Auction End:</div>
                                                                        <div class="ShortAuctionDataValue"><?php
                                                                            echo date('d M Y, H:s:i', strtotime($Auction['date_end'])) ?>
                                                                        </div>
                                                                        <!--<div class="ShortAuctionDataBidRow">
                                      <div class="ShortAuctionDataLabel">Minimum Bid:</div>
                                      <div class="ShortAuctionDataValue"><b><?php
                                                                        echo number_format($Auction['price'], 0, ',', ',') ?></b> <img src="<?php
                                                                        echo $template_path; ?>/images//account/icon-tibiacointrusted.png" class="VSCCoinImages" title="Transferable Tibia Coins"></div>
                                    </div>-->
                                                                        <div class="ShortAuctionDataBidRow">
                                                                    ...
                                                                    if ($logged) { ?> <!-- LOGGED -->
                                                                        <?php
                                                                        if ($Auction['account_old'] != $account_logged) { ?>
                                                                            <div class="AuctionBodyBlock CurrentBid">
                                                                                <div class="Container">
                                                                                    ...
                                                                                    <form action="?subtopic=currentcharactertrades&action=bid" method="post">
                                                                                        <input type="hidden" name="auction_iden" value="<?php
                                                                                        echo $Auction['id'] ?>">
                                                                                        <input class="MyMaxBidInput" type="number" name="maxbid" min="<?php
                                                                                        echo $Auction['price'] ?>">
                                                                                        <div class="BigButton" style="background-image:url(<?php
                                                                                        echo $template_path; ?>/images/global/buttons/sbutton_green.gif)">
                                                                                            <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                                                                                                <div class="BigButtonOver" style="background-image: url(<?php
                                                                                                echo $template_path; ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div>
                                                                                                <input name="auction_confirm" class="BigButtonText" type="submit" value="Bid On Auction"></div>
                                                                                        </div>
                                                                                    </form>
                                                                                </div>
                                                                            </div>
...
if (isset($getPageDetails)) {
                                                ...
                                                <td>
                                                    <div class="Auction">
                                                        <div class="AuctionHeader">
                                                            ...
                                                            <div class="AuctionCharacterName"><?php
                                                                echo $getCharacter['name'] ?></div>
                                                            Level: <?php
                                                            echo $getCharacter['level'] ?> | Vocation: <?php
                                                            echo $character_voc ?> | <?php
                                                            echo $character_sex ?><br>
                                                        ...
                                                        <div class="AuctionBody">
                                                            <div class="AuctionBodyBlock AuctionDisplay AuctionOutfit" style="font-size: 10px; text-align: center;">
                                                                Current outfit:
                                                                <img class="AuctionOutfitImage" src="<?php
                                                                echo $outfit_url ?>">
                                                            </div>
                                                            <div class="AuctionBodyBlock AuctionDisplay AuctionItemsViewBox">
                                                                <div class="CVIcon CVIconObject" title="amulet"><?php
                                                                    echo $equipment[2]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="helmet"><?php
                                                                    echo $equipment[1]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="backpack"><?php
                                                                    echo $equipment[3]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="hand"><?php
                                                                    echo $equipment[6]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="armor"><?php
                                                                    echo $equipment[4]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="hand"><?php
                                                                    echo $equipment[5]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="ring"><?php
                                                                    echo $equipment[9]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="legs"><?php
                                                                    echo $equipment[7]; ?></div>
                                                                <div class="CVIcon CVIconObject" title="extra"><?php
                                                                    echo $equipment[10]; ?></div>
                                                                <div class="CVIcon CVIconObject" style="font-size: 10px; text-align: center;" title="soul">Soul<br><?php
                                                                    echo $getCharacter['soul'] ?></div>
                                                                <div class="CVIcon CVIconObject" title="boots"><?php
                                                                    echo $equipment[8]; ?></div>
                                                                <div class="CVIcon CVIconObject" style="font-size: 10px; text-align: center;" title="cap">Cap<br><?php
                                                                    echo $getCharacter['cap'] ?></div>
                                                            </div>
                                                            <div class="AuctionBodyBlock ShortAuctionData">
                                                                <div class="ShortAuctionDataLabel">Auction Start:</div>
                                                                <div class="ShortAuctionDataValue"><?php
                                                                    echo date('d M Y', strtotime($getAuction['date_start'])) ?></div>
                                                                <div class="ShortAuctionDataLabel">Auction End:</div>
                                                                <div class="ShortAuctionDataValue"><?php
                                                                    echo date('d M Y', strtotime($getAuction['date_end'])) ?></div>
                                                                <div class="ShortAuctionDataBidRow">
                                                                    <div class="ShortAuctionDataLabel">Current Bid:</div>
                                                                    <div class="ShortAuctionDataValue"><b><?php
                                                                            echo number_format($getAuction['price'], 0, ',', ',') ?></b> <img src="<?php
                                                                        echo $template_path; ?>/images//account/icon-tibiacointrusted.png" class="VSCCoinImages" title="Transferable Tibia Coins"></div>
                                                                </div>
                                                                <?php
                                                                if ($logged && $account_logged == $getAuctionBid['account_id']) { ?>
                                                            ...
                                                            <?php
                                                            if ($logged && $getAuction['status'] == 0) { ?>
                                                                <?php
                                                                if (strtotime($End) > strtotime($Hoje) && $account_logged != $getAuction['account_old']) { ?>
                                                                    <div class="AuctionBodyBlock CurrentBid">
                                                                        <div class="Container">
                                                                            <div class="MyMaxBidLabel">My Bid Limit</div>
                                                                            <form action="?subtopic=currentcharactertrades&action=bid" method="POST">
                                                                ...
                                                                <?php
                                                                if (strtotime($End) < strtotime($Hoje) && $account_logged == $getAuction['account_old'] && $account_logged != $getAuction['bid_account']) { ?>
                                                                    <div class="AuctionBodyBlock CurrentBid">
                                                                        <div class="Container">
                                                                                ...
                                                                                <form method="post" action="?subtopic=currentcharactertrades&action=finish">
                                                                                    ...
                                                                                    echo $template_path; ?>/images/global/buttons/sbutton_green.gif)">
                                                                                        <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                                                                                            <div class="BigButtonOver" style="background-image: url(<?php
                                                                                            echo $template_path; ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div>
                                                                                            <input name="auction_finish" class="BigButtonText" type="button" value="Finish Auction"></div>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <?php
                                                                if (strtotime($End) < strtotime($Hoje) && $account_logged == $getAuction['bid_account'] && $account_logged != $getAuction['account_old']) { ?>
                                                                    <div class="AuctionBodyBlock CurrentBid">
                                                                        <div class="Container">
                                                                            <div class="MyMaxBidLabel" style="font-weight: bold; color: green;">
                                                                                <form method="post" action="?subtopic=currentcharactertrades&action=finish">
                                                            ...
                                                            <div class="AuctionBodyBlock SpecialCharacterFeatures">
                                                                <div class="Entry">
                                                                    <img class="CharacterFeatureCategory" src="<?php
                                                                    echo $template_path; ?>/images/charactertrade/usp-category-3.png">Blessings active: <?php
                                                                    echo $BlessCount ?>/7, Twist of Fate active: <?php
                                                                    echo $BlessTwist ?>
                                                                </div>
                                                                <div class="Entry">
                                                                    <img class="CharacterFeatureCategory" src="<?php
                                                                    echo $template_path; ?>/images/charactertrade/usp-category-7.png">Total Charm Points <?php
                                                                    echo $Charm_Points ?>, Unused Charm Points: <?php
                                                                    echo $Charm_UsedPoints ?>
                                                                </div>
                                                                <div class="Entry">
                                                                    <img class="CharacterFeatureCategory" src="<?php
                                                                    echo $template_path; ?>/images/charactertrade/usp-category-0.png">10 Distance Fighting (Loyalty bonus not included)
                                                                </div>
                                                                <div class="Entry">
                                                                    <img class="CharacterFeatureCategory" src="<?php
                                                                    echo $template_path; ?>/images/charactertrade/usp-category-0.png">10 Shielding (Loyalty bonus not included)
                                                                </div>
    ...
    <div class="TopButtonContainer">
        <div class="TopButton" style="">
            <a href="#top">
                ...
                echo $template_path; ?>/images/content/back-to-top.gif">
            </a>
        </div>
    </div>
    <div class="TableContainer">
                                                        ...
                                                        <tr class="Even">
                                                            <td><span class="LabelV">Health:</span>
                                                                <div style="float:right; text-align: right;"><?php
                                                                    echo $getCharacter['health'] ?> / <?php
                                                                    echo $getCharacter['healthmax'] ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Odd">
                                                            <td><span class="LabelV">Mana:</span>
                                                                <div style="float:right; text-align: right;"><?php
                                                                    echo $getCharacter['mana'] ?> / <?php
                                                                    echo $getCharacter['manamax'] ?></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Even">
                                                ...
                                                <div class="TableContentContainer">
                                                    <table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
                                                        ...
                                                        <tr class="Even">
                                                            ...
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_axe'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_axe_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_axe_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Odd">
                                                            <td class="LabelColumn"><b>Club Fighting</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_club'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_club_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_club_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Even">
                                                            <td class="LabelColumn"><b>Distance Fighting</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_dist'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_dist_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_dist_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Odd">
                                                            <td class="LabelColumn"><b>Fishing</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_fishing'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_fishing_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_fishing_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Even">
                                                            <td class="LabelColumn"><b>Fist Fighting</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_fist'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_fist_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_fist_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Odd">
                                                            <td class="LabelColumn"><b>Magic Level</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['maglevel'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: 0%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString">0 %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Even">
                                                            <td class="LabelColumn"><b>Shielding</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_shielding'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_shielding_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_shielding_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        <tr class="Odd">
                                                            <td class="LabelColumn"><b>Sword Fighting</b></td>
                                                            <td class="LevelColumn"><?php
                                                                echo $getCharacter['skill_sword'] ?></td>
                                                            <td class="PercentageColumn">
                                                                <div id="SkillBar" class="PercentageBar" style="width: <?php
                                                                echo $getCharacter['skill_sword_tries'] ?>%">
                                                                    <div class="PercentageBarSpacer"></div>
                                                                </div>
                                                                <div class="PercentageStringContainer"><span class="PercentageString"><?php
                                                                        echo $getCharacter['skill_sword_tries'] ?> %</span></div>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
                                            ...
                                            <tr class="Even">
                                                <td><span class="LabelV">Creation Date:</span>
                                                    <div style="float:right; text-align: right;"><?php
                                                        echo date('d M Y, G:i:s', $getCharacter['created']) ?></div>
                                                </td>
                                            </tr>
                                            <tr class="Odd">
                                                <td><span class="LabelV">Experience:</span>
                                                    <div style="float:right; text-align: right;"><?php
                                                        echo number_format($getCharacter['experience'], 0, ',', ',') ?></div>
                                                </td>
                                            </tr>
                                            <tr class="Even">
                                                <td><span class="LabelV">Gold:</span>
                                                    <div style="float:right; text-align: right;"><?php
                                                        echo $getCharacter['balance'] ?></div>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
    ...
    <div class="TableContainer">
        <div class="CaptionContainer">
            <div class="CaptionInnerContainer"><span class="CaptionEdgeLeftTop" style="background-image:url(<?php
                ...
                echo $template_path; ?>/images/global/content/box-frame-vertical.gif);"></span> <span class="CaptionBorderBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/table-headline-border.gif);"></span> <span class="CaptionEdgeLeftBottom" style="background-image:url(<?php
                echo $template_path; ?>https://static.tibia.com/images/global/content/box-frame-edge.gif);"></span> <span class="CaptionEdgeRightBottom" style="background-image:url(<?php
                echo $template_path; ?>/images/global/content/box-frame-edge.gif);"></span></div>
        </div>
        <table class="Table3" cellspacing="0" cellpadding="0">
            <tbody>
                                                        ...
                                                        <div class="BlockPage BlockPageObject">
                                                            ...
                                                            foreach ($getDepotItems as $DepotItem) { ?>
                                                                <div class="CVIcon CVIconObject">
                                                                    <img src="<?php
                                                                    echo $template_path; ?>/images/charactertrade/objects/<?php
                                                                    echo $DepotItem['sid'] ?>.gif">
                                                                    <?php
                                                                    if ($DepotItem['count'] > 1) { ?>
                                                                        <div class="ObjectAmount"><?php
                                                                            echo $DepotItem['count'] ?></div>
                                                                    <?php
                                                                    } ?>
                                                                </div>
                                                            <?php
    ...
    <div class="CharacterDetailsBlock " id="Charms"><a name="Charms"></a>
        <div class="TopButtonContainer"><a name="Charms"></a>
            <div class="TopButton"><a name="Charms"></a><a onclick="ScrollToAnchor('top');"><img style="border: 0px;" src="<?php
                    echo $template_path; ?>/images/global/content/back-to-top.gif"></a></div>
        </div>
        <div class="TableContainer">
            <div class="CaptionContainer">
                <div class="CaptionInnerContainer"><span class="CaptionEdgeLeftTop" style="background-image:url(<?php
                                    ...
                                    <td>
                                        <div class="TableContentContainer">
                                            <table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
                                                ...
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_wound ?> Rune Wound
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_enflame ?> Rune Enflame
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_poison ?> Rune Poison
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_freeze ?> Rune Freeze
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_zap ?> Rune Zap
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_curse ?> Rune Curse
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_cripple ?> Rune Cripple
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_parry ?> Rune Parry
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_dodge ?> Rune Dodge
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_adrenaline ?> Rune Aadrenaline
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_numb ?> Rune Numb
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_cleanse ?> Rune Cleanse
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_bless ?> Rune Bless
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_scavenge ?> Rune Scavenge
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_gut ?> Rune Gut
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_low_blow ?> Rune Low Blow
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_divine ?> Rune Divine
                                                    </td>
                                                </tr>
                                                <tr class="Odd">
                                                    <td><?php
                                                        echo $rune_vamp ?> Rune Vamp
                                                    </td>
                                                </tr>
                                                <tr class="Even">
                                                    <td><?php
                                                        echo $rune_void ?> Rune Void
                                                    </td>
                                                </tr>
    ...
    <div class="CharacterDetailsBlock " id="CompletedQuestLines"><a name="Completed Quest Lines"></a>
        <div class="TopButtonContainer"><a name="Completed Quest Lines"></a>
            <div class="TopButton"><a name="Completed Quest Lines"></a><a onclick="ScrollToAnchor('top');"><img style="border: 0px;" src="<?php
                    echo $template_path; ?>/images/global/content/back-to-top.gif"></a></div>
        </div>
        <div class="TableContainer">
            <div class="CaptionContainer">
...
if ($getPageAction == 'bid') {
    ...
    if ($logged && $getAuction['account_old'] != $account_logged) {
                                            ...
                                            <table class="TableContent" style="border:1px solid #faf0d7;" width="100%">
                                                ...
                                                <tr>
                                                    <td style="font-weight:normal;"><?php
                                                        echo $getAccount['coins'] ?> <img src="<?php
                                                        echo $template_path; ?>/images/account/icon-tibiacoin.png"> (<?php
                                                        echo $getAccount['coins'] ?> <img src="<?php
                                                        echo $template_path; ?>/images/account/icon-tibiacointrusted.png">)
                                                    </td>
                                                    <td style="font-weight:normal;"><?php
                                                        echo $charbazaar_bid ?> <img src="<?php
                                                        echo $template_path; ?>/images/account/icon-tibiacointrusted.png"> to give an bid.
                                                    </td>
                                                </tr>
                                                </tbody>
                                            </table>
                        ...
                        <td>
                            <div class="InnerTableContainer">
                                <table style="width:100%;">
                                            ...
                                            <table style="width:50%;">
                                                ...
                                                if ($Verif_Price == 'true' and $Verif_CoinsAcc == 'true') {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php
                                                            echo $Auction_maxbid ?> <img src="<?php
                                                            echo $template_path; ?>/images//account/icon-tibiacointrusted.png" class="VSCCoinImages" title="Transferable Tibia Coins"></td>
                                                    </tr>
                                                <?php
                                                } else { ?>
                                                    <tr>
                                    ...
                                    <tr>
                                        <td><br>If you confirm this bid, a <b>deposit</b> of <b>50</b> <img src="<?php
                                            echo $template_path; ?>/images//account/icon-tibiacointrusted.png" class="VSCCoinImages" title="Transferable Tibia Coins"> transferable Tibia Coins will be subtracted from your account's Tibia Coins balance.<br>If someone is submiting a <b>higher bid</b>, the <b>deposit will be returned</b> to your account.
                                        </td>
                                    </tr>
                                    </tbody>
                                </table>
            ...
            <div class="TableContainer">
                <div class="CaptionContainer">
                    <div class="CaptionInnerContainer">
                        <span class="CaptionEdgeLeftTop" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-edge.gif);"></span>
                        <span class="CaptionEdgeRightTop" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-edge.gif);"></span>
                        <span class="CaptionBorderTop" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/table-headline-border.gif);"></span>
                        <span class="CaptionVerticalLeft" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-vertical.gif);"></span>
                        <div class="Text">Erro</div>
                        <span class="CaptionVerticalRight" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-vertical.gif);"></span>
                        <span class="CaptionBorderBottom" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/table-headline-border.gif);"></span>
                        <span class="CaptionEdgeLeftBottom" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-edge.gif);"></span>
                        <span class="CaptionEdgeRightBottom" style="background-image:url(<?php
                        echo $template_path; ?>/images/content/box-frame-edge.gif);"></span>
                    </div>
                </div>
                <table class="Table1" cellspacing="0" cellpadding="0">
            ...
            if ($Verif_Price == 'true' && $Verif_CoinsAcc == 'true') {
                ...
                echo $template_path; ?>/images/global/buttons/sbutton_green.gif)">
                    <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                        <div class="BigButtonOver" style="background-image: url(<?php
                        echo $template_path; ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div>
                        <input name="auction_confirm" class="BigButtonText" type="submit" value="Submit Bid" data-bs-toggle="modal" data-bs-target="#ModalOpenFinishBid"></div>
                </div>
		...
		<img src="<?php
                            echo $template_path; ?>/images/content/circle-symbol-minus.gif" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
      </div>-->
                            <div class="modal-body">
                                <div style="width: 100%; display: flex; justify-content: center; align-items: center;">
                                    <img src="<?php
                                    echo $template_path; ?>/images/charactertrade/confirm.gif"> <span style="font-weight: bold; font-size: 16px; padding-left: 10px; text-align: left;">You submitted a bid successfully.<br><small style="font-weight: 100;">You will be redirected in a few moments.</small></span>
                                </div>
                            </div>
                            <div class="modal-footer">
                                <!--<div class="BigButton" style="background-image:url(<?php
                                echo $template_path; ?>/images/global/buttons/sbutton_red.gif)"><div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);"><div class="BigButtonOver" style="background-image: url(<?php
                                echo $template_path; ?>/images/global/buttons/sbutton_red_over.gif); visibility: hidden;"></div><input name="auction_confirm" class="BigButtonText" type="button" value="Close" data-bs-dismiss="modal"></div></div>-->
                                <form method="post" action="?subtopic=currentcharactertrades&action=bidfinish">
                                    <input type="hidden" name="bid_iden" value="<?php
                                    echo $getAuction['id'] ?>">
                                    <input type="hidden" name="bid_max" value="<?php
                                    echo $Auction_maxbid ?>">
                                    <div class="BigButton" style="background-image:url(<?php
                                    echo $template_path; ?>/images/global/buttons/sbutton_green.gif)">
                                        <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                                            <div class="BigButtonOver" style="background-image: url(<?php
                                            echo $template_path; ?>/images/global/buttons/sbutton_green_over.gif); visibility: hidden;"></div>
                                            <input name="bid_confirm" class="BigButtonText" type="submit" value="Exit"></div>
                                    </div>
                                </form>
                            </div>
                        </div>
            ...
            <a href="?subtopic=currentcharactertrades">
                <div class="BigButton" style="background-image:url(<?php
                echo $template_path; ?>/images/global/buttons/sbutton_red.gif)">
                    <div onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                        <div class="BigButtonOver" style="background-image: url(<?php
                        echo $template_path; ?>/images/global/buttons/sbutton_red_over.gif); visibility: hidden;"></div>
