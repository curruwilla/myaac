...
if ($logged) {
    ...
    ?>
    <div class="CharacterTradeTibiaCoinBalance"><?php
        echo $getAccountCoins['coins'] ?><img src="<?php
        echo $template_path; ?>/images//account/icon-tibiacoin.png" class="VSCCoinImages" title="Tibia Coins"> <?php
        echo $getAccountCoins['coins'] ?><img src="<?php
                                                        ...
                                                        <td>
                                                            <div class="Auction">
                                                                <div class="AuctionHeader">
                                                                    <div class="AuctionLinks"><a href="?subtopic=pastcharactertrades&details=<?php
                                                                    ...
                                                                    <div class="AuctionCharacterName"><a href="?subtopic=pastcharactertrades&details=<?php
                                                                        echo $Auction['id'] ?>"><?php
                                                        ...
                                                        <div class="AuctionBody">
                                                            ...
                                                            <div class="AuctionBodyBlock ShortAuctionData">
                                                                ...
                                                                <div class="ShortAuctionDataBidRow">
                                                                    <div class="ShortAuctionDataLabel">Winning Bid:</div>
                                                                    <div class="ShortAuctionDataValue"><b><?php
                                                                            echo number_format($getAuction['bid_price'], 0, ',', ',') ?></b> <img src="<?php
                                                                        echo $template_path; ?>/images//account/icon-tibiacointrusted.png" class="VSCCoinImages" title="Transferable Tibia Coins"></div>
                                                                </div>
                                                                <?php
                                                                if ($account_logged == $getAuctionBid['account_id']) { ?>
