                                        ...
                                        <table class="TableContent" width="100%" style="border:1px solid #faf0d7;">
                                            ...
                                            <tr>
                                                <td style="text-align: center;">
                                                    ...
                                                    <a href="<?= $config['client_link'] ?? '' ?>" target="_new"><img style="width: 90px; height: 90px; border: 0;" src="<?= $template_path; ?>/images/download_windows.gif"></a>
                                                    <br>
                                                    <a href="<?= $config['client_link'] ?? '' ?>" target="_new" style="font-size: 12pt;">Download Client</a>
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>
...
if (isset($_GET['subtopic']) && $_GET['subtopic'] == 'downloadclient' && $getpage_download == 'downloadagreement') {
    ?>
            ...
            <tr>
                <td>
                    <div class="InnerTableContainer"><p>This agreement describes the terms on which CipSoft GmbH offers you access to an account for being able to play the online role playing game "Tibia". By creating an account or downloading the client software you accept the terms and conditions below and state that you are of full legal age in your country or have the permission of your parents to play this game.</p>
                        ...
                        <p>CipSoft GmbH is neither willing nor required to take part in out-of-court dispute resolution.</p>
                        <p>By creating an account or downloading the client software, you also accept the terms and conditions stated in the BattlEye End-User Licence Agreement.</p>
