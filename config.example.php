...
$config = [
    ...
    'character_samples' => [ // vocations, format: ID_of_vocation => 'Name of Character to copy'
        //0 => 'Rook Sample',
        1 => 'Sorcerer Sample',
        2 => 'Druid Sample',
        3 => 'Paladin Sample',
    ...
    // characters page
    'characters' => [ // what things to display on character view page (true/false in each option)
        'level' => true,
        'experience' => true,
        'magic_level' => true,
        'balance' => true,
