...
<head>
    ...
    <script type="text/javascript">
        let menus = '';
        let loginStatus = "<?= ($logged ? 'true' : 'false'); ?>";
        <?php
        if (PAGE !== 'news') {
        ...
        let activeSubmenuItem = "<?= $tmp; ?>";
        let IMAGES = "<?= $template_path; ?>/images";
...
if (!empty($config['network_facebook'])) { ?>
    <script type="text/javascript">
...
<div id="top"></div>
<div id="ArtworkHelper" style="background-image:url(<?= $template_path; ?>/images/header/<?= $config['background_image']; ?>);">
    <div id="Bodycontainer">
        <div id="ContentRow">
            <div id="MenuColumn">
                ...
                <div id="Loginbox">
                    ...
                    <div id="LoginButtonContainer" style="background-image:url(<?= $template_path; ?>/images/loginbox/loginbox-textfield-background.gif)">
                        <div id="LoginButton" style="background-image:url(<?= $template_path; ?>/images/global/buttons/mediumbutton.gif)">
                            <div onClick="LoginButtonAction();" onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);">
                                <div class="Button" style="background-image:url(<?= $template_path; ?>/images/global/buttons/mediumbutton-over.gif)"></div>
                    ...
                    <div class="Loginstatus" style="background-image:url(<?= $template_path; ?>/images/loginbox/loginbox-textfield-background.gif)">
                        <div id="LoginstatusText_2" onClick="LoginstatusTextAction(this);" onMouseOver="MouseOverLoginBoxText(this);" onMouseOut="MouseOutLoginBoxText(this);">
                            <div id="LoginstatusText_2_1" class="LoginstatusText" style="background-image:url(<?= $template_path; ?>/images/loginbox/loginbox-font-create-account.gif)"></div>
                            <div id="LoginstatusText_2_2" class="LoginstatusText" style="background-image:url(<?= $template_path; ?>/images/loginbox/loginbox-font-create-account-over.gif)"></div>
                        </div>
                    </div>
                        ...
                        <a href="?subtopic=downloadclient&step=downloadagreement">
                            <div id="PlayNowContainer">
                                <div class="MediumButtonBackground" style="background-image:url(<?= $template_path; ?>/images/global/buttons/mediumbutton.gif)" onmouseover="MouseOverBigButton(this);" onmouseout="MouseOutBigButton(this);">
                                    <div class="MediumButtonOver" style="background-image: url(<?= $template_path; ?>/images/global/buttons/mediumbutton-over.gif); visibility: hidden;"></div>
                                    <input class="MediumButtonText" type="image" name="Download" alt="Download" src="<?= $template_path; ?>/images/global/buttons/mediumbutton_download.png"></div>
                            </div>
                        </a>
                    </div>
                            ...
                            <span onClick="MenuItemAction('<?= $cat['id']; ?>')">
                                <div class='MenuButton' style='background-image:url(<?= $template_path; ?>/images/menu/button-background.gif);'>
                                    <div onMouseOver='MouseOverMenuItem(this);' onMouseOut='MouseOutMenuItem(this);'><div class='Button' style='background-image:url(<?= $template_path; ?>/images/menu/button-background-over.gif);'></div>
                                        ...
                                        <div id='<?= $cat['id']; ?>_Icon' class='Icon' style='background-image:url(<?= $template_path; ?>/images/menu/icon-<?= $cat['id']; ?>.gif);'></div>
                            ...
                            <div id='<?= $cat['id']; ?>_Submenu' class='Submenu'>
                                ...
                                foreach ($menus[$id] as $category => $menu) {
                                    ...
                                    <a href='<?= $menu['link_full']; ?>'<?= $menu['blank'] ? ' target="_blank"' : '' ?>>
                                        <div id='submenu_<?= str_replace('/', '', $menu['link']); ?>' class='Submenuitem' onMouseOver='MouseOverSubmenuItem(this)' onMouseOut='MouseOutSubmenuItem(this)' style="color: <?= $link_color; ?>;">
                                            <div class='LeftChain' style='background-image:url(<?= $template_path; ?>/images/general/chain.gif);'></div>
                                            <div id='ActiveSubmenuItemIcon_<?= str_replace('/', '', $menu['link']); ?>' class='ActiveSubmenuItemIcon' style='background-image:url(<?= $template_path; ?>/images/menu/icon-activesubmenu.gif);'></div>
                                            <div class='SubmenuitemLabel' style="color: <?= $link_color; ?>;"><?= $menu['name']; ?></div>
                    ...
                    if ($config['status_bar'] == true) { ?>
                        <div class="Box">
                            ...
                            <div class="BorderTitleText" style="background-image:url(<?= $template_path; ?>/images/global/content/newsheadline_background.gif); height: 28px;">
                                <div class="InfoBar">
                                    <?php
                                    if (isset($config['discord_link']) && !empty($config['discord_link'])) { ?>
                                        <img class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-discord.png">
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="<?= $config['discord_link']; ?>" target="new"><span class="InfoBarSmallElement">Join Discord</span></a>
                                        </span>
                                        <?php
                                    } ?>
                                    <?php
                                    if (isset($config['whatsapp_link']) && !empty($config['whatsapp_link'])) { ?>
                                        <img class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-whatsapp.png" width="16">
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="https://wa.me/<?= $config['whatsapp_link']; ?>" target="new"><span class="InfoBarSmallElement">Whatsapp</span></a>
                                        </span>
                                        <?php
                                    } ?>
                                    <?php
                                    if (isset($config['instagram_link']) && !empty($config['instagram_link'])) { ?>
                                        <img class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-instagram.png" width="16">
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="https://www.instagram.com/<?= $config['instagram_link']; ?>" target="new"><span class="InfoBarSmallElement">Instagram</span></a>
                                        </span>
                                        <?php
                                    } ?>
                                    <?php
                                    if (isset($config['facebook_link']) && !empty($config['facebook_link'])) { ?>
                                        <img class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-facebook.png" width="16">
                                        <span class="InfoBarNumbers">
                                            <a class="InfoBarLinks" href="https://www.facebook.com/<?= $config['facebook_link']; ?>" target="new"><span class="InfoBarSmallElement">Facebook</span></a>
                                        </span>
                                        <?php
                                    } ?>
                                    <img class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-download.png">
                                        <span class="InfoBarNumbers">
                                        <a class="InfoBarLinks" href="?subtopic=downloadclient"><span class="InfoBarSmallElement">Download</span></a>
                                    </span>
                                    
                                    <span style="float: right; margin-top: -2px;">
                                        <img alt="Players online" class="InfoBarBigLogo" src="<?= $template_path; ?>/images/global/header/icon-players-online.png">
                                        <span class="InfoBarNumbers">
                                            <span class="InfoBarSmallElement">
                                                <a class="InfoBarLinks" href="?online"><?= $status['online'] ? $status['players'] . ' Players Online' : 'Server Offline' ?></a>
                                            </span>
                                        </span>
                                        <?php
                                        if ($config['collapse_status'] == true) { ?>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="InnerTableContainer" style="display: flex; flex-wrap: wrap; font-family: Verdana;">
                                                    <?php
                                                    if ($config['carousel_status'] == true) { ?>
                                                                                                ...
                                                                                                foreach ($config['carousel'] as $carousel) {
                                                                                                    if ($count == 1) {
                                                                                                        ...
                                                                                                        <div class="carousel-item active">
                                                                                                            <img src="<?= $template_path ?>/images/carousel/<?= $carousel ?>" style="width: 100%;">
                                                                                                        </div>
                                                                                                        <?php
                                                                                                    } elseif ($count > 1) {
                                                                                                        ?>
                    ...
                    <div id="ContentHelper">
                        ...
                        <div id="<?= PAGE; ?>" class="Box">
                            ...
                            <div class="Border_2">
                                <div class="Border_3">
                                    <?php
                                    $hooks->trigger(HOOK_TIBIACOM_BORDER_3); ?>
            ...
            <div id="ThemeboxesColumn">
                ...
                ?>
                <div id="RightArtwork">
                    <img id="Monster" src="<?= $config['outfit_images_url'] ?>?id=<?= $monstertype; ?>&addons=<?= $monsteraddons; ?>&head=<?= $monsterhead; ?>&body=<?= $monsterbody; ?>&legs=<?= $monsterlegs; ?>&feet=<?= $monsterfeet; ?>&mount=<?= $monstermount; ?>" alt="Monster of the Day" title="Today's boosted creature: <?= ucwords(strtolower(trim($monstername))); ?>">
