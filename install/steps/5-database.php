    ...
    if (!$error) {
        ...
        if (isset($database_error)) { // we failed connect to the database
            ...
            if (!$error) {
                ...
                $content .= '$config[\'session_prefix\'] = \'myaac_' . generateRandomString(8, true, false, true) . '_\';';
                $content .= PHP_EOL;
                $content .= '$config[\'cache_prefix\'] = \'myaac_' . generateRandomString(8, true, false, true) . '_\';';
